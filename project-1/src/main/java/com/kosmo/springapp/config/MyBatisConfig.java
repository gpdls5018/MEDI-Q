...
@Configuration
@MapperScan(value = {"com.kosmo.springapp.service", "com.kosmo.springapp.nutrient.service","com.kosmo.springapp.analyze.service"}, sqlSessionFactoryRef = "sqlSessionFactory")
