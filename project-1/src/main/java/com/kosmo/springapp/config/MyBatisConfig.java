...
@Configuration
@MapperScan(value = {"com.kosmo.springapp.service", "com.kosmo.springapp.nutrient.service","com.kosmo.springapp.analyze.service","com.kosmo.springapp.qnabbs.service"}, sqlSessionFactoryRef = "sqlSessionFactory")
