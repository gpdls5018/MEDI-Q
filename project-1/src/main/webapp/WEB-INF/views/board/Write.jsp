        ...
        <div class="container-fluid pt-3 mt-3">
            <div class="row d-flex flex-wrap align-content-stretch">
                ...
                <div class="d-flex col-8 flex-wrap flex-direction justify-content-center align-content-stretch">
                    <div class="col">
                        <form method="post" action="/board/WriteProcess.do">
                            ...
                            <button type="submit" class="btn btn-light text-light text1" style ="background:linear-gradient(0deg,#ffa585,#fedacd);">등록</button>
                        </form>
                    </div>
                </div>
