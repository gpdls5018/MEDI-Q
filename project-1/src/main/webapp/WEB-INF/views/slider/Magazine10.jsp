...
<div class="container custom-top">
  ...
  <div class="paragraph">
    ...
    <div class="mt-4">
     ...
     <div class="mt-5">
      <img src="<c:url value="/resources/images/magazine_images/10/img_green1.png"/>" class="img-fluid">
    </div>
  </div>
  <div class="paragraph">
    <div class="mt-5">
    ...
    <div class="mt-4">
      <img src="<c:url value="/resources/images/magazine_images/number/one_W.png"/>" class="img-fluid mb-2 mr-2" style="width:40px">
    ...
    <div class="mt-5">
     <img src="<c:url value="/resources/images/magazine_images/number/two_W.png"/>" class="img-fluid mb-2 mr-2" style="width:40px">
  ...
  <div class="paragraph">
   ...
   <div class="paragraph">
    ...
    <div class="mt-5">
      <img src="<c:url value="/resources/images/magazine_images/10/img_green2.png"/>" class="img-fluid">
    </div>
    </div>
    <div class="paragraph">
       <span class="underLine" style="color:#FF7C4C; font-size: 23px;"><strong>DSM-5의 월경전불쾌감장애 진단 기준</strong></span>
    <div class="mt-4">
     	 <img src="<c:url value="/resources/images/magazine_images/number/a.png"/>" class="img-fluid mb-2 mr-1" style="width:40px">
    ...
    <div class="mt-4">
     	<img src="<c:url value="/resources/images/magazine_images/number/b.png"/>" class="img-fluid mb-2 mr-1" style="width:40px">
    ...
    <div class="mt-4">
     	<img src="<c:url value="/resources/images/magazine_images/number/c.png"/>" class="img-fluid mb-2 mr-1" style="width:40px"> 
     	...
     	<div class="ml-5 mt-3 mb-2">
	        ...
	        <p>
	          <img src="<c:url value="/resources/images/magazine_images/number/seven_B.png"/>" class="img-fluid mb-2 mr-1" style="width:40px">
    ...
    <div class="mt-4">
     	<img src="<c:url value="/resources/images/magazine_images/number/d.png"/>" class="img-fluid mb-2 mr-1" style="width:40px"> 
     	증상이 직업이나 학교, 일상적인 사회 활동과 대인관계를 현저하게 저해한다.<br/>
     	<span class="ml-5">(예: 사회활동의 회피, 직장이나 학교에서의 생산성과 효율성의 감소)</span>
    </div>
     <div class="mt-4">
     	<img src="<c:url value="/resources/images/magazine_images/number/e.png"/>" class="img-fluid mb-2 mr-1" style="width:40px"> 
     ...
     <div class="mt-4">
     	<img src="<c:url value="/resources/images/magazine_images/number/f.png"/>" class="img-fluid mb-2 mr-1" style="width:40px"> 
     ...
     <div class="mt-4">
     	<img src="<c:url value="/resources/images/magazine_images/number/g.png"/>" class="img-fluid mb-2 mr-1" style="width:40px"> 
