        ...
        <div class="container">
            ...
            <div class="textdialog">
	            ...
	            <div class="alert alert-danger alert-dismissible fade show py-2">
				    ...
				    <strong id="stt-msg" style="font-size: 12px;"> </strong><br/><!-- 문맥이 이어질 수 있게 한줄로 요약해서 작성하면 좋을 것 같아. 시연시에는 STT와 TTS 둘다 지원이 가능한 경우일테니까! -->
				    <strong id="tts-msg" style="font-size: 12px;"> </strong>
				    <label for="voice" style="font-size: 12px;">음성을 선택하세요</label><!-- 나중에 지원할 경우에만 노출되도록 코드 작성해야해! -->
