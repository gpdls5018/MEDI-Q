...
<link rel="icon" type="image/png" href="https://cdn.pillyze.io/web/img/browser-icon/icon-m.png" sizes="96x96">
<link rel="icon" type="image/png" href="https://cdn.pillyze.io/web/img/browser-icon/icon-l.png" sizes="128x128">
...
<style>
    @media screen and (max-width: 510px) {
            .health-wrap .health-one.fatigue {
            background: #fff url(http://imgproxy.pillyze.io/ZMRFlYGcp8jgvkT0hiNtU6ZjmJTVf1hcUw4YnIZI0EU/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2ZhdGlndWUucG5n) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.eyes {
            background: #fff url(http://imgproxy.pillyze.io/hlGUVSeFIjT1R2qL8SZ-X1yJF2AWOaUja2gA6zENZP8/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2V5ZXMucG5n) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.skincare {
            background: #fff url(http://imgproxy.pillyze.io/9hxxZJcJXEN140bUHh9E3c1lQcp1Wbefbw0Rmnpt3Wo/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3NraW5jYXJlLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.fat {
            background: #fff url(http://imgproxy.pillyze.io/dkJw00WkM2gzj6zx85N-Hw8Na3X1_G4V-VNnTKO8wnY/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2ZhdC5wbmc) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.blood_circulation {
            background: #fff url(http://imgproxy.pillyze.io/rB1Q3HjFQm_teat6bKTSEZ34JiZRzUZw0BE5D1L_0fE/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2Jsb29kX2NpcmN1bGF0aW9uLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.liver {
            background: #fff url(http://imgproxy.pillyze.io/U42UAa-cp39jAGzftu9OzLrtJ9Cz-kijMpJGAsHfTfw/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2xpdmVyLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.intestine {
            background: #fff url(http://imgproxy.pillyze.io/xmFVESTN45bxZGMpCMw0pp8UQReukauvhiktsvvJ-0M/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2ludGVzdGluZS5wbmc) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.sleep {
            background: #fff url(http://imgproxy.pillyze.io/ldlFd0lIfxK6m0ocgqsmsar75vym5plnu3eP558xNao/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3NsZWVwLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.immunity {
            background: #fff url(http://imgproxy.pillyze.io/ycxN-UcS2CMAgOoBMpOSlkGtQO-5EQTD57Qgv3d5TjE/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2ltbXVuaXR5LnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.cholesterol {
            background: #fff url(http://imgproxy.pillyze.io/kZQfKpEN1aePQh_mmtVq6x6it8_yXf-hLvkpcf-1lSY/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2Nob2xlc3Rlcm9sLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.bones {
            background: #fff url(http://imgproxy.pillyze.io/db4H5Es2BAexMxmVzlACxzC1L9kLQemmsawI9CNPjSY/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2JvbmVzMi5wbmc) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.anti-aging {
            background: #fff url(http://imgproxy.pillyze.io/0dtK5dYrsf4vU8VoK5W_qtUxytCyecT_d_DTqOlkcXY/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2FudGktYWdpbmcucG5n) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.women {
            background: #fff url(http://imgproxy.pillyze.io/q0M09XsdLPKjk8HI9eEN04NgMMLxzWU0Yc5GnNsuyF4/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3dvbWVuLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.stomach {
            background: #fff url(http://imgproxy.pillyze.io/bHlVxdaNQd6uc11mkXVq-WeSVX3dmqDmckjeOSZMTX0/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3N0b21hY2gucG5n) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.men {
            background: #fff url(http://imgproxy.pillyze.io/DcuMbV8F2YPJKBBkJCPrGevac7nu-_9ArXqKCoWF6qw/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL21lbi5wbmc) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.blood_pressure {
            background: #fff url(http://imgproxy.pillyze.io/76KNDnfgnkUzTgBioLm_N84OyzwiM17oTVyBb7SFdDo/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2Jsb29kX3ByZXNzdXJlLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.strength {
            background: #fff url(http://imgproxy.pillyze.io/atB_jiWzEiNi-iN2OnnrcOUNvtrZn_dWypwPRllgXkk/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3N0cmVuZ3RoLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.brain {
            background: #fff url(http://imgproxy.pillyze.io/MFuRGlartQIX5LX5vd41oaQLN7NK4FlfRb3ctpEm0js/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2JyYWluLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.blood_sugar {
            background: #fff url(http://imgproxy.pillyze.io/ueQnM7QZ_04uOH7gliNGOwFTqy3yO-Li-I9u9VzQA7M/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2Jsb29kX3N1Z2FyLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.neutral_fat {
            background: #fff url(http://imgproxy.pillyze.io/kZQfKpEN1aePQh_mmtVq6x6it8_yXf-hLvkpcf-1lSY/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2Nob2xlc3Rlcm9sLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.tooth {
            background: #fff url(http://imgproxy.pillyze.io/zSvVwv0pJY-GPW2tuhsf1-IHSH7Jqx_ygo4UPRQKREg/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3Rvb3RoLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.pregnant {
            background: #fff url(http://imgproxy.pillyze.io/VEQ70eVSCWQ-d-oHhsSNTfAPtA49jX-gbZlThGS9zBo/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3ByZWduYW50LnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.hair_loss {
            background: #fff url(http://imgproxy.pillyze.io/I8HSfgYXVdBb7zHaG9sPl4Zlp4hynkg94Fjsm7e8K7Y/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2hhaXJfbG9zcy5wbmc) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.joint {
            background: #fff url(http://imgproxy.pillyze.io/mxvTxbMtPCqn5cISM6AxfrK2XFCQG3gFoqXklu-FH1w/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2pvaW50LnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.menopause {
            background: #fff url(http://imgproxy.pillyze.io/Dewk3IlumtR5hUS02edPNi8uSREyPMEU-CL31j8qHNc/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9zaWRlX2VmZmVjdHMvbWVub3BhdXNlLnBuZw) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.respiratory {
            background: #fff url(http://imgproxy.pillyze.io/twSYw4y256mq_JdGUIf-rmCUJndn9X95xfkrbZbYMao/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2JyZWF0aC5wbmc) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.thyroid {
            background: #fff url(http://imgproxy.pillyze.io/0dXEHLf-lYAgVVmOhGgYKwFFs3PEWjTrin_5AF4Rvbs/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL3RoeXJvaWQucG5n) center no-repeat;
            background-size: 70px 70px;
        }

        .health-wrap .health-one.anemia {
            background: #fff url(http://imgproxy.pillyze.io/liFTLnRRqcU8ptnEkyT0340I5L_WqLds8TXlo8iBfsU/rs:fill:100:100/czM6Ly9waWxseXplLXByZC1pbWFnZS9pY29ucy9oaWdzL2FuZW1pYS5wbmc) center no-repeat;
            background-size: 70px 70px;
        }
